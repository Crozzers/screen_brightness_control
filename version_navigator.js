var all_nav_links={"API Version":{"docs/0.27.1":["docs/0.27.0"],"docs/0.26.0":[],"docs/0.25.0":[],"docs/0.24.3":["docs/0.24.2","docs/0.24.1","docs/0.24.0"],"docs/0.23.0":[],"docs/0.22.2":["docs/0.22.1","docs/0.22.0"],"docs/0.21.0":[],"docs/0.20.0":[],"docs/0.19.0":[],"docs/0.18.0":[],"docs/0.17.0":[],"docs/0.16.2":["docs/0.16.1","docs/0.16.0"],"docs/0.15.5":["docs/0.15.4","docs/0.15.3","docs/0.15.2","docs/0.15.1","docs/0.15.0"],"docs/0.14.2":["docs/0.14.1","docs/0.14.0"],"docs/0.13.2":["docs/0.13.1","docs/0.13.0"],"docs/0.12.0":[],"docs/0.11.5":["docs/0.11.4","docs/0.11.3","docs/0.11.2","docs/0.11.1","docs/0.11.0"],"docs/0.10.1":["docs/0.10.0"],"docs/0.9.0":[],"docs/0.8.6":["docs/0.8.5","docs/0.8.4","docs/0.8.3","docs/0.8.2","docs/0.8.1","docs/0.8.0"],"docs/0.7.2":["docs/0.7.1","docs/0.7.0"],"docs/0.6.1":["docs/0.6.0"],"docs/0.5.1":[]},"Extras":["extras/Examples.html","extras/FAQ.html","extras/Installing On Linux.html","extras/Quick Start Guide.html"]};var mark_latest={"API Version":"docs/0.27.1"};function newElement(parent,elem){var element=document.createElement(elem);parent.appendChild(element);return element;}
...
function outofdate_redirect(latest_url,latest_stub){base=get_version_navigation_base_url()
var fragment=window.location.toString().replace(base,'',1).split('/').slice(latest_stub.replace(/^\/+|\/+$/,'').split('/').length).join('/')
var potential_url=new URL(fragment,latest_url+'/');var request=new XMLHttpRequest();request.open('HEAD',potential_url,true);request.onreadystatechange=function(){if(request.readyState===4){if(request.status===200){document.location.href=potential_url}else{document.location.href=latest_url}}};request.send();}
function spawn_outofdate_label(latest_url,latest_stub){var div=document.createElement("div");div.className="pdoc notice-marker";var latest=document.createElement("a");latest.href="javascript:void(0);"
latest.onclick=function(){outofdate_redirect(latest_url,latest_stub)}
latest.innerHTML="This page is out of date. Click here to see the latest version";div.appendChild(latest);var main=document.getElementsByTagName("body")[0];main.appendChild(div);}
...
if(window.location.href.startsWith(new URL(url_stub,get_version_navigation_base_url()))){spawn_outofdate_label(latest_url,latest);break loop1;}}}}
